...

{
   ...
   /* private void Start()
    {
        reppelGameObjects = new Transform[numberOfPrefabs]; // Initialize the array
        SpawnPrefabs();
    }*/
    void SpawnPrefabs()
    {
        for (int i = reppelGameObjects.Length-1; i < numberOfPrefabs; i++)
        {
            ...
            reppelGameObjects[i] = spawnedObject.transform; // Store the transform in the array
        }
    }
